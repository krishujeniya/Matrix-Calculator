...
def Matrix_2x2():
    ...
    scrollbar = Scrollbar(df, orient=VERTICAL, command=canvas.yview)
    ...
    result_frame = Frame(frame, bg="black")
    ...
    Button(frame, text="Determinant", command=calculate_determinant, bg="maroon", fg="white", font="arial 30").grid(row=8, column=0, columnspan=2, pady=20)
    Button(frame, text="Inverse", command=calculate_inverse, bg="maroon", fg="white", font="arial 30").grid(row=9, column=0, columnspan=2, pady=20)
...
def Matrix_3x3():
    ...
    Button(frame, text="Determinant", command=calculate_determinant, bg="maroon", fg="white", font="arial 30").grid(row=9, column=1, columnspan=3, pady=20)
    Button(frame, text="Inverse", command=calculate_inverse, bg="maroon", fg="white", font="arial 30").grid(row=10, column=1, columnspan=3, pady=20)
